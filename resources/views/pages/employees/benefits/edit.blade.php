        ...
        <div class="w-[50%] py-10 box-border">
            <header class="flex items-center gap-2">
                ...
                <div>
                    ...
                    <h1 class="text-4xl font-black -mt-1">Update Employee Benefit</h1>
                </div>
            </header>
            ...
            <form method="POST">
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <x-benefit-type-selector class="w-full border btn py-2">{{$benefitType['id']}}</x-benefit-type-selector>
                    </div>
                    <div>
                ...
                <button type="submit" class="btn btn-primary mt-4 float-right"><i class="bi bi-save"></i> Update Benefit</button>
            </form>
